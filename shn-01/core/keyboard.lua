...
function keyboard:key_down(key, code)
    self.pressedChars[key] = true
    self.pressedCodes[code] = true
end

globalEvents.onKeyDown:subscribe(function(key, code) keyboard:key_down(key, code) end)

function keyboard:key_up(key, code)
    self.pressedChars[key] = nil
    self.pressedCodes[code] = nil
end
globalEvents.onKeyUp:subscribe(function(key, code) keyboard:key_up(key, code) end)
